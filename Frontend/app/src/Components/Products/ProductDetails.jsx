...
const ProductDetails = () => {
    ...
    const singleProduct = useSelector((state) => state.products.singleProduct.data);
    ...
    //     "imgUrl": "https://images.bewakoof.com/t1080/gojo-domain-oversized-fit-t-shirt-520746-1658344284-1.jpg",
    //     "imgArray": [
        ...
        <Box display={"flex"} w={"75%"} margin={"auto"} mt={"4%"}>
            <Box w={"50%"} display={"flex"}>
                <Box w={"30%"} >
                    ...
                    {singleProduct && singleProduct.imgArray.map((e, i) => (
                        <Box key={i} p={"5px"}>
            ...
            <Box textAlign={"left"}>
                ...
                <Box display={"flex"} fontSize={"14px"} fontWeight={"semibold"} mt={"20px"}>
                    <Box display={"flex"} bgColor={"#ffd84d"} borderRadius={"3px"} h={"40px"} cursor={"pointer"} alignItems={"center"} p={"0 40px"}>
